...
[drop'in RFCs]: #dropin-rfcs

This workflow is heavily inspired by [Rust RFCs](https://github.com/rust-lang/rfcs).

Many changes, including bug fixes and documentation improvements can be
implemented and reviewed via the normal GitHub pull request workflow.

Some changes though are "substantial", and we ask that these be put through a
bit of a design process and produce a consensus among the drop'in community and
the sub-teams.
...
the drop'in language, drop'in tools, or the RFC process itself. What constitutes
...
the drop'in community's sub-team specific guidelines for:
...
the idea over [Github Discussions](https://github.com/blue-forest/dropin/discussions).
...
In short, to get a major feature added to drop'in, one must first get the RFC
...
feature as a pull request to the drop'in repo. Being "active" is not a rubber
...
it imply anything about whether a drop'in developer has been assigned the task
...
associated issue tracking its implementation in the drop'in repository; thus
that associated issue can be assigned a priority via the triage process that
the team uses for all issues in the drop'in repository.
